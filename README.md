...
This is a simple application that initially renders a cube. After clicking on it new figure appears on random position with random color and a shape.
...
``` https://randomprimitive.netlify.app ```
